...
- [x] **src/FullSDNPipeline/ directory:** Created complete new pipeline:
...
# ── Full Pipeline Demo ──
python src/FullSDNPipeline/sdn_pipeline.py --demo
python src/FullSDNPipeline/sdn_pipeline.py --pcap-dir .../Labeled/Friday --limit 500

# ── Packet Shooter ──
python src/FullSDNPipeline/packet_shooter.py --pcap-dir .../Labeled/Friday --rate-multiplier 1.0

# ── One-command Demo ──
bash src/FullSDNPipeline/run_demo.sh demo
bash src/FullSDNPipeline/run_demo.sh friday
```
